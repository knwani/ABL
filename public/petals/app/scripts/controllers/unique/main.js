 ...
 */
angular.module('petalsApp').controller('UniqueCtrl', function ($scope, $http, myDateService, $rootScope) {
  ...
  $scope.loadArticles = function (){
    ...
    $scope.promise = $http.get('api/get_unique').then(function(response){
...
angular.module('petalsApp').controller('EditUniqueCtrl', function ($scope, $http, myDateService, $routeParams, FileUploader, $rootScope) {
