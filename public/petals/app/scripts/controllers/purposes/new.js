 ...
 */
angular.module('petalsApp').controller('NewPurposeCtrl', function ($scope, $http, FileUploader, $location, $rootScope) {
  ...
  $scope.addPurpose = function (){
    ...
    $scope.promise = $http.post('api/add_purpose', {payload: $scope.post_data}).then(function(response){
        //callNotification('Your project has been successfully created. Hang on, taking you to your project now','notice');
      //NProgress.done();
      console.log(response);
      //$location.path("/projects/" + response);
