 ...
 */
angular.module('petalsApp').controller('AskKennyCtrl', function ($scope, $http, myDateService, $rootScope) {
        ...
        buttons: {
              somethingElse: {
                ...
                action: function(){
                  ...
                  $scope.promise = $http.post('api/delete_question', {payload: $scope.post_data}).then(function(response){
                    callNotification('Question has been deleted','notice');
                    NProgress.done();
                    $scope.articles = response.data.questions;
                    //console.log(response);
                  }, function(response){
